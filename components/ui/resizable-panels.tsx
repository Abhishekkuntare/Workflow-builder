...
const useResizeObserverErrorFix = () => {
  useEffect(() => {
    // This is the proper way to handle ResizeObserver loop errors
    // We catch the error and prevent it from bubbling up
